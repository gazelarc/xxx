...
wget -O /etc/nginx/nginx.conf "https://github.com/gazelarc/xxx/blob/master/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "http://autoscript.id.ai/Script/index.html"
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://github.com/gazelarc/xxx/blob/master/vps.conf"
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://github.com/gazelarc/xxx/blob/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://github.com/gazelarc/xxx/blob/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://github.com/gazelarc/xxx/blob/master/1194-client.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://github.com/gazelarc/xxx/blob/master/snmpd.conf"
...
wget -O limit.sh "http://autoscript.id.ai/Script/limit.sh"
curl http://autoscript.id.ai/Script/cekuser.sh > cekuser.sh
curl http://autoscript.id.ai/Script/user-expire.sh > user-expire.sh
curl http://autoscript.id.ai/Script/user-limit.sh > user-limit.sh
...
# info
clear
echo "gazelarc | 085766274144 | Script dari KangArie|" | tee log-install.txt
